...
public class TC_Pressure_Min_Max_Data_Validations extends TC_LoginTest_DDT_001 {
	...
	public void PressureValues_Min_19_Max_2(String min, String max) throws InterruptedException {
		...
		// verify the login is successful
		if (driver.getPageSource().contains("Pressure Alert range should have a minimum difference of 0.34 BAR")) {
			System.out.println("Pressure value 1.9 and 2 accepted not accepted");
			softAssert.assertEquals(true, pmv.saveButtonEnabled());
		}

		else {

			System.out.println("Pressure value 1.9 and 2 accepted");
